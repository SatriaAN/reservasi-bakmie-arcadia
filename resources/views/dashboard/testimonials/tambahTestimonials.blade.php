                        ...
                        <form method="POST" action="{{ url('testimonials') }}">
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control  @error('testimonials') is-invalid @enderror" id="testimonials" type="text"
                                    placeholder="Testimoni" style="height: 10rem;" data-sb-validations="required" name="testimonials"> {{ old('testimonials') }}</textarea>
